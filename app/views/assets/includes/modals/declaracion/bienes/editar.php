                ...
                <form action="#" method="POST" autocomplete="" id="form-crear">
                    ...
                    <div class="slide-page slide-page-crear">
                        ...
                        <div class="form-group">
                            <input class="form-control" type="text" name="anioparametros" placeholder="Mansión" value="Lorem ipsum dolor sit amet.">
                        </div>
                        <label for="" class="form-label">Valor</label>
                        <div class="form-group">
                            <input class="form-control" type="text" name="valor" placeholder="000000000" value="1000000000">
                        </div>
                        ...
                        <select class="form-control" name="tipomoneda" required>
                            ...
                            <option value="pesoscolombianos" selected>Pesos Colombianos</option>
                        ...
                        <select class="form-control" name="tipomoneda" required>
                            ...
                            <option value="pesoscolombianos" selected>Casa</option>
                            <option value="pesoschilenos">Pesos Chilenos</option>
                            <option value="dolareseeuu">Dolares EEUU</option>
                        </select>
                        </div>
