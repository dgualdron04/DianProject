<ul>
    ...
    <li class="item item-list">
        ...
        <div class="sub-menu">
            <a href="<?php echo constant('URL'); ?>app/views/assets/manuales/manualdeclarante.pdf" title="Manual de Usuario"><i class="fas fa-address-book"></i><span>Manual de usuario</span></a>
        </div>
    </li>
</ul>